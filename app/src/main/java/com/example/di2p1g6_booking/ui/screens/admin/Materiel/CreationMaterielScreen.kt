package com.example.di2p1g6_booking.ui.screens.admin.Materiel
...
fun CreationMaterielScreen() {
    ...
    AdminLayout {
        Column(
            ...
            WhiteSquare(title = "Création d'un matériel") {
                BasicTextField("Nom du matériel : ")
...
@Composable
fun CreationMaterielScreenPreview() {
    CreationMaterielScreen()
}